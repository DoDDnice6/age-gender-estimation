...
from generator_imdb import ImageGenerator
...
def main():
    ...
    train_gen = ImageGenerator(
        "/home/dodat/Documents/python-projects/age-gender-estimation/data/imdb_crop", "imdb", image_size=64, batch_size=batch_size)
    val_gen = ImageGenerator("/home/dodat/Documents/python-projects/age-gender-estimation/data/wiki_crop",
                             "wiki", image_size=64, batch_size=batch_size)
    print(train_gen.len())
    print(val_gen.len())
    ...
    pd.DataFrame(hist.history).to_hdf(output_path.joinpath(
        "history_{}_{}.h5".format(16, 8)), "history")
